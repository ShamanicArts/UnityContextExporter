...
{
    // Moved ExportMode enum here, directly under the namespace
    ...
    {
        // ExportMode enum is now defined outside this class but within the same namespace
        ...
        public static void ShowWindowMenu()
        {
            ...
            // ExportMode is directly accessible as it's in the same namespace
        ...
        void OnGUI()
        {
            ...
            // ExportMode enum will be resolved from the namespace
        ...
        {
            // FullJsonDataV2 will be resolved from the namespace
            ...
            if (_exportMode == ExportMode.SpecificComponentOnly)
            {
                ...
                // ComponentDataContextual will be resolved from the namespace
            ...
            else
            {
                ...
                // GameObjectData and AssetData will be resolved from the namespace
        ...
        // GameObjectData, TransformData, ComponentData will be resolved from the namespace
        ...
        // AssetData will be resolved from the namespace
        ...
        // PropertyData will be resolved from the namespace
    ...
    // These are now also within the ShamanicArts.ContextExporter.Editor namespace
